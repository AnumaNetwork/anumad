...
func TestUTXOIndex(t *testing.T) {
	...
	rewardsMinedSompi := uint64(blockAmountToMine * constants.SompiPerAnuma * 17)
	...
	rewardsMinedViaBlockCountSompi := uint64(
		(getBlockCountResponse.BlockCount - 2) * constants.SompiPerAnuma * 17, // -2 because of genesis and virtual.
	)
