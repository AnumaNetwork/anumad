...
import (
	...
	"github.com/AnumaNetwork/anumad/infrastructure/network/netadapter/server"
...
type grpcStream interface {
	Send(*protowire.AnumadMessage) error
	Recv() (*protowire.AnumadMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.AnumadMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.AnumadMessage) error {
