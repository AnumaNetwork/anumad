...
// Params defines a Anuma network by its parameters. These parameters may be
// used by Anuma applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// Further details: https://hashdag.medium.com/anuma-launch-plan-9a63f4d754a6
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: https://github.com/AnumaNetwork/research/issues/3
...
// MainnetParams defines the network parameters for the main Anuma network.
...
// TestnetParams defines the network parameters for the test Anuma network.
var TestnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "anuma-testnet-10",
	Net:         appmessage.Testnet,
	RPCPort:     "12512",
	DefaultPort: "12513",
	DNSSeeds: []string{
		"testnet-dns.anuma.network",
	},
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixAnumaTest,
...
// SimnetParams defines the network parameters for the simulation test Anuma
...
var SimnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixAnumaSim,
...
// DevnetParams defines the network parameters for the development Anuma network.
var DevnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixAnumaDev,
...
// ErrDuplicateNet describes an error where the parameters for a Anuma
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate Anuma network")

var registeredNets = make(map[appmessage.AnumaNet]struct{})

// Register registers the network parameters for a Anuma network. This may
