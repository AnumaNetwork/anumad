...
func (v *transactionValidator) checkTransactionAmountRanges(tx *externalapi.DomainTransaction) error {
	...
	// as a sompi. One anuma is a quantity of sompi as defined by the
	// sompiPerAnuma constant.
	...
	for _, txOut := range tx.Outputs {
		...
		// This is impossible for Anuma, but perhaps possible if an alt increases
