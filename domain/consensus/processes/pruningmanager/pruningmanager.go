...
import (
	...
	"github.com/AnumaNetwork/anumad/domain/consensus/utils/multiset"
	"github.com/AnumaNetwork/anumad/domain/consensus/utils/utxo"
	"github.com/AnumaNetwork/anumad/domain/consensus/utils/virtual"
...
// This is a sanity test, to make sure that anumad doesn't store, and subsequently sends syncing peers the wrong UTXOSet.
