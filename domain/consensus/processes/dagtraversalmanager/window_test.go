	...
	tests := map[string][]*struct {
		...
		dagconfig.MainnetParams.Name: {
			...
			},
			{
				parents:        []string{"H", "F"},
				id:             "I",
				expectedWindow: []string{"F", "H", "B", "C", "D", "G"},
			},
			{
				parents:        []string{"I"},
				id:             "J",
				expectedWindow: []string{"I", "F", "H", "B", "C", "D", "G"},
			},
			//
			{
				parents:        []string{"J"},
				id:             "K",
				expectedWindow: []string{"J", "I", "F", "H", "B", "C", "D", "G"},
			},
			{
				parents:        []string{"K"},
				id:             "L",
				expectedWindow: []string{"K", "J", "I", "F", "H", "B", "C", "D", "G"},
			},
			{
				parents:        []string{"L"},
				id:             "M",
				expectedWindow: []string{"L", "K", "J", "I", "F", "H", "B", "C", "D", "G"},
			},
			{
				parents:        []string{"M"},
				id:             "N",
				expectedWindow: []string{"M", "L", "K", "J", "I", "F", "H", "B", "C", "D"},
			},
			{
				parents:        []string{"N"},
				id:             "O",
				expectedWindow: []string{"N", "M", "L", "K", "J", "I", "F", "H", "B", "C"},
			},
		},
		dagconfig.TestnetParams.Name: {
			...
			},
			{
				parents:        []string{"H", "F"},
				id:             "I",
				expectedWindow: []string{"F", "B", "H", "C", "G", "D"},
			},
			{
				parents:        []string{"I"},
				id:             "J",
				expectedWindow: []string{"I", "F", "B", "H", "C", "G", "D"},
			},
			{
				parents:        []string{"J"},
				id:             "K",
				expectedWindow: []string{"J", "I", "F", "B", "H", "C", "G", "D"},
			},
			{
				parents:        []string{"K"},
				id:             "L",
				expectedWindow: []string{"K", "J", "I", "F", "B", "H", "C", "G", "D"},
			},
			{
				parents:        []string{"L"},
				id:             "M",
				expectedWindow: []string{"L", "K", "J", "I", "F", "B", "H", "C", "G", "D"},
			},
			{
				parents:        []string{"M"},
				id:             "N",
				expectedWindow: []string{"M", "L", "K", "J", "I", "F", "B", "H", "C", "G"},
			},
			{
				parents:        []string{"N"},
				id:             "O",
				expectedWindow: []string{"N", "M", "L", "K", "J", "I", "F", "B", "H", "C"},
			},
		},
