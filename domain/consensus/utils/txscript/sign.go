...
// SignatureScript creates an input signature script for tx to spend ANUM sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend ANUM sent
