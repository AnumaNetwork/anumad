...
import (
	...
	"github.com/AnumaNetwork/anumad/domain/consensus/utils/serialization"
	...
	"github.com/AnumaNetwork/anumad/util/binaryserializer"
...
// writeTransactionInput encodes ti to the anuma protocol encoding for a transaction
// input to w.
