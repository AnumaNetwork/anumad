...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "mainnet p2pk",
			addr:    "anuma:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35cdv0dy335",
			encoded: "anuma:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35cdv0dy335",
			valid:   true,
		...
		{
			name:    "testnet p2pk",
			addr:    "anumatest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35ckquw528z",
			encoded: "anumatest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35ckquw528z",
			valid:   true,
			result: util.TstAddressPubKey(
		...
		// ECDSA P2PK tests.
		{
			...
			addr:    "anuma:qyp0r5mcq4rd5grj3652ra09u5dcgwqq9ntuswp247nama5quyj40eq03sc2dkx",
			encoded: "anuma:qyp0r5mcq4rd5grj3652ra09u5dcgwqq9ntuswp247nama5quyj40eq03sc2dkx",
			valid:   true,
		...
		{
			name:    "testnet p2sh",
			addr:    "anumatest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx35yyy2h9",
			encoded: "anumatest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx35yyy2h9",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixAnumaTest,
				[blake2b.Size256]byte{
...
func TestDecodeAddressErrorConditions(t *testing.T) {
	tests := []struct {
		...
		{
			"anumasim:raskzctpv9skzctpv9skzctpv9skzctpvy37ct7zafpv9skzctpvymmnd3gh8",
		...
		{
			"anumatest:qqq65mvpxcmajeq44n2n8vfn6u9f8l4zsy0xez0tzw",
			util.Bech32PrefixAnuma,
