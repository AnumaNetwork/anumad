...
func TestAddresses(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:    "mainnet p2pk",
			addr:    "anuma:qq2u4dvcpvdcn0k03afx0lgqhlj06kk0ay8std3t87tuexlhq7m87e4n078d6",
			encoded: "anuma:qq2u4dvcpvdcn0k03afx0lgqhlj06kk0ay8std3t87tuexlhq7m87e4n078d6",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixAnuma,
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe9, 0xe3, 0x60, 0x8b, 0x11, 0xdb, 0x9b, 0x98, 0x16, 0xac,
					0x6b, 0x3b}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixAnuma)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixAnuma,
		},
		{
			name:    "mainnet p2pk 2",
			addr:    "anuma:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
			encoded: "anuma:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixAnuma,
				[util.PublicKeySize]byte{
			...
			passedPrefix:   util.Bech32PrefixAnuma,
			expectedPrefix: util.Bech32PrefixAnuma,
		},
		{
			name:    "testnet p2pk",
			addr:    "anumatest:qph45l0y247vu078ktt3g0r0qefeqqqxrushmz4hlv2fjg6vfk3njk7pp4mh0",
			encoded: "anumatest:qph45l0y247vu078ktt3g0r0qefeqqqxrushmz4hlv2fjg6vfk3njk7pp4mh0",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixAnumaTest,
				[util.PublicKeySize]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixAnumaTest)
			},
			passedPrefix:   util.Bech32PrefixAnumaTest,
			expectedPrefix: util.Bech32PrefixAnumaTest,
		},

		// ECDSA P2PK tests.
		{
			name:    "mainnet ecdsa p2pk",
			addr:    "anuma:q835ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35e2sm7yrlr4w",
			encoded: "anuma:q835ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35e2sm7yrlr4w",
			valid:   true,
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c, 0xaa}
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixAnuma)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixAnuma,
		},
		...
		},
		{
			...
			addr:           "anuma:qr35ennsep3hxfe7lnz5ee7j5jgmkjswss74as46gx",
			valid:          false,
			passedPrefix:   util.Bech32PrefixAnuma,
			expectedPrefix: util.Bech32PrefixAnuma,
		},
		...
		{
			name:    "mainnet p2sh",
			addr:    "anuma:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
			encoded: "anuma:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
			valid:   true,
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32PrefixAnuma)
			},
			passedPrefix:   util.Bech32PrefixAnuma,
			expectedPrefix: util.Bech32PrefixAnuma,
		},
		{
			name:    "mainnet p2sh 2",
			addr:    "anuma:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
			encoded: "anuma:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixAnuma,
				[32]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixAnuma)
			},
			passedPrefix:   util.Bech32PrefixAnuma,
			expectedPrefix: util.Bech32PrefixAnuma,
		},
		{
			name:    "testnet p2sh",
			addr:    "anumatest:qpcs7zh3ufpv20eekyyy0f7u6fgz0mm9mf9s778qqx2zfvfmnxx86gjmfwhnh",
			encoded: "anumatest:qpcs7zh3ufpv20eekyyy0f7u6fgz0mm9mf9s778qqx2zfvfmnxx86gjmfwhnh",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixAnumaTest,
				[32]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixAnumaTest)
			},
			passedPrefix:   util.Bech32PrefixAnumaTest,
			expectedPrefix: util.Bech32PrefixAnumaTest,
		},
...
func TestDecodeAddressErrorConditions(t *testing.T) {
	tests := []struct {
		...
		//{
		//	"anumasim:qz830led3jg2wpym5nv8wfg6g3nz8cwt92zhc4azpzgjr6rz95nezuqmzj40a",
		//	util.Bech32PrefixAnumaSim,
		//	"unknown address type",
		//},
		//{
		//	"anumasim:raskzcg58mth0an",
		//	util.Bech32PrefixAnumaSim,
		//	"unknown address type",
		//},
		{
			"anumatest:qpcs7zh3ufpv20eekyyy0f7u6fgz0mm9mf9s778qqx2zfvfmnxx86gjmfwhnh",
			util.Bech32PrefixAnuma,
...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"anuma", util.Bech32PrefixAnuma, false},
		{"anumatest", util.Bech32PrefixAnumaTest, false},
		{"anumasim", util.Bech32PrefixAnumaSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixAnuma, "anuma"},
		{util.Bech32PrefixAnumaTest, "anumatest"},
		{util.Bech32PrefixAnumaSim, "anumasim"},
		{util.Bech32PrefixUnknown, ""},
	}
