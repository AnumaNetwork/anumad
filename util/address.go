...
import (
	...
	"github.com/AnumaNetwork/anumad/util/bech32"
)
...
const (
	...
	Bech32PrefixAnumaDev

	// Prefix for the test network.
	Bech32PrefixAnumaTest

	// Prefix for the simulation network.
	Bech32PrefixAnumaSim
)
...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"anuma":     Bech32PrefixAnuma,
	"anumadev":  Bech32PrefixAnumaDev,
	"anumatest": Bech32PrefixAnumaTest,
	"anumasim":  Bech32PrefixAnumaSim,
}
...
// and a payload which encodes the anuma network and address type. It is used
