...
func ExampleAmount() {
	...
	// Output:
	// Zero Sompi: 0 ANUM
	// 100,000,000 Sompi: 1 ANUM
	// 100,000 Sompi: 0.001 ANUM
}
...
func ExampleNewAmount() {
	...
	// 0.01234567 ANUM
	// 0 ANUM
	// invalid anuma amount
}

func ExampleAmount_unitConversions() {
	amount := util.Amount(44433322211100)

	fmt.Println("Sompi to kANUM:", amount.Format(util.AmountKiloANUM))
	fmt.Println("Sompi to ANUM:", amount)
	fmt.Println("Sompi to MilliANUM:", amount.Format(util.AmountMilliANUM))
	fmt.Println("Sompi to MicroANUM:", amount.Format(util.AmountMicroANUM))
	fmt.Println("Sompi to Sompi:", amount.Format(util.AmountSompi))

	// Output:
	// Sompi to kANUM: 444.333222111 kANUM
	// Sompi to ANUM: 444333.222111 ANUM
	// Sompi to MilliANUM: 444333222.111 mANUM
	// Sompi to MicroANUM: 444333222111 μANUM
