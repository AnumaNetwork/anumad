...
// By having at least 0.2ANUM in the change output we make sure that every transaction with send value >= 0.2ANUM
...
const minChangeTarget = constants.SompiPerAnuma / 5
