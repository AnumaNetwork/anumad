...
func (x *GetVersionRequest) Reset() {
	*x = GetVersionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_anumawalletd_proto_msgTypes[23]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetVersionRequest) Descriptor() ([]byte, []int) {
	return file_anumawalletd_proto_rawDescGZIP(), []int{23}
}
...
func (x *GetVersionResponse) Reset() {
	*x = GetVersionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_anumawalletd_proto_msgTypes[24]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetVersionResponse) Descriptor() ([]byte, []int) {
	return file_anumawalletd_proto_rawDescGZIP(), []int{24}
}
...
var file_anumawalletd_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_anumawalletd_proto_goTypes = []interface{}{
	...
	(*GetVersionRequest)(nil),                  // 23: anumawalletd.GetVersionRequest
	(*GetVersionResponse)(nil),                 // 24: anumawalletd.GetVersionResponse
}
var file_anumawalletd_proto_depIdxs = []int32{
	...
	23, // 14: anumawalletd.anumawalletd.GetVersion:input_type -> anumawalletd.GetVersionRequest
	1,  // 15: anumawalletd.anumawalletd.GetBalance:output_type -> anumawalletd.GetBalanceResponse
	18, // 16: anumawalletd.anumawalletd.GetExternalSpendableUTXOs:output_type -> anumawalletd.GetExternalSpendableUTXOsResponse
	4,  // 17: anumawalletd.anumawalletd.CreateUnsignedTransactions:output_type -> anumawalletd.CreateUnsignedTransactionsResponse
	6,  // 18: anumawalletd.anumawalletd.ShowAddresses:output_type -> anumawalletd.ShowAddressesResponse
	8,  // 19: anumawalletd.anumawalletd.NewAddress:output_type -> anumawalletd.NewAddressResponse
	12, // 20: anumawalletd.anumawalletd.Shutdown:output_type -> anumawalletd.ShutdownResponse
	10, // 21: anumawalletd.anumawalletd.Broadcast:output_type -> anumawalletd.BroadcastResponse
	20, // 22: anumawalletd.anumawalletd.Send:output_type -> anumawalletd.SendResponse
	22, // 23: anumawalletd.anumawalletd.Sign:output_type -> anumawalletd.SignResponse
	24, // 24: anumawalletd.anumawalletd.GetVersion:output_type -> anumawalletd.GetVersionResponse
...
func file_anumawalletd_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_anumawalletd_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
		...
		file_anumawalletd_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
